...
In Unix-style file system context, a single period '.' signifies the current directory, a double period ".."
 ...
 In this problem, treat sequences of periods not covered by the previous rules (like "...") as valid names for 
...
class Solution(object):
    def simplifyPath(self, path):
        ...
        res = ""
        # we need to append in reverse order since stack will contain name of last directory
        while stack:
            res = "/" + stack.pop() + res
